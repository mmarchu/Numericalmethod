...
import './screen.css';
import { BookFilled,FunctionOutlined } from '@ant-design/icons';
...
class App extends Component {
  ...
  render() {
    return (
      <Router>
        <Layout>
          <Header className="header" style={{backgroundColor:"#5F5A4D" ,height: "120px" }}>
            <div className="headertext">
              <label><FunctionOutlined style={{color:"#FFA32F",fontSize:"40px", marginRight:"10px"}}/><h2 style={{color:"#FFA32F"}}>Numerical Method Calculaters</h2></label>
            </div>
          </Header>
          <Layout>
          <Sider width={335} style={{ background: "#fff" }}>
              <Menu
                mode="inline"
                style={{ height: '90vh', borderRight: 0, backgroundColor: "#766333", overflowY: "scroll" }}
                theme="light"
              >
          ...
          <Footer style={{ backgroundColor: "#5F5A4D", minHeight: 120 }}>
            <p style={{ fontSize: "20px", fontWeight: "bold", color: "white" }}>
              ...
              <p>Numerical Methods 040613393</p>
              <p >Ammar Chuapoodee 6204062663128</p>
            </p>
          </Footer>
        </Layout>
      </Router>
